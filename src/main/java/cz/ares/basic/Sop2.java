...
@XmlType(name = "sop", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3", propOrder = {
    "csp",
    "t"
})
public class Sop2 {
     ...
     * 
     */
    public List<Clen2> getCSP() {
        if (csp == null) {
            csp = new ArrayList<Clen2>();
        }
        return this.csp;
    }
