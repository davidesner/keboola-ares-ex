 ...
 *       &lt;sequence>
 *         &lt;element name="Obor_cinnosti" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.5}obor_cinnosti" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class OboryCinnosti3 {

    @XmlElement(name = "Obor_cinnosti")
    protected List<OborCinnosti3> oborCinnosti;
     ...
     * 
     */
    public List<OborCinnosti3> getOborCinnosti() {
        if (oborCinnosti == null) {
            oborCinnosti = new ArrayList<OborCinnosti3>();
        }
