...
@XmlType(name = "sos", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3", propOrder = {
    "css",
    "t"
})
public class Sos2 {
     ...
     * 
     */
    public List<Clen2> getCSS() {
        if (css == null) {
            css = new ArrayList<Clen2>();
        }
        return this.css;
    }
