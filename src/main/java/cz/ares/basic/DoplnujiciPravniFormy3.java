 ...
 *       &lt;sequence>
 *         &lt;element name="PF" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.5}pravni_forma" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class DoplnujiciPravniFormy3 {

    @XmlElement(name = "PF")
    protected List<PravniForma3> pf;
     ...
     * 
     */
    public List<PravniForma3> getPF() {
        if (pf == null) {
            pf = new ArrayList<PravniForma3>();
        }
        return this.pf;
    }
