...
@XmlType(name = "udalosti", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3", propOrder = {
    "u"
})
public class Udalosti2 {

    @XmlElement(name = "U", required = true)
    protected List<Udalost2> u;
     ...
     * 
     */
    public List<Udalost2> getU() {
        if (u == null) {
            u = new ArrayList<Udalost2>();
        }
        return this.u;
    }
