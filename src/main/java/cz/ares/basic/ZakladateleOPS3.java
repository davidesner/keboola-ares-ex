 ...
 *       &lt;sequence>
 *         &lt;element name="ZOPS" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.5}angazma" maxOccurs="unbounded"/>
...
public class ZakladateleOPS3 {

    @XmlElement(name = "ZOPS", required = true)
    protected List<Angazma3> zops;
    @XmlElement(name = "T")
     ...
     * 
     */
    public List<Angazma3> getZOPS() {
        if (zops == null) {
            zops = new ArrayList<Angazma3>();
        }
        return this.zops;
    }
