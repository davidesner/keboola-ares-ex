...
/**
 * Texty pøedmìtù podnikání, ostat.skuteènosti atd. s atributy
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="Text" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2}textType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
...
@XmlType(name = "texty", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.2", propOrder = {
    "text"
})
public class Texty {
