 ...
 *       &lt;sequence>
 *         &lt;element name="SB" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.5}angazma" maxOccurs="unbounded" minOccurs="0"/>
...
public class SpolecniciBezVkladu3 {

    @XmlElement(name = "SB")
    protected List<Angazma3> sb;
    @XmlElement(name = "T")
     ...
     * 
     */
    public List<Angazma3> getSB() {
        if (sb == null) {
            sb = new ArrayList<Angazma3>();
        }
        return this.sb;
    }
