 ...
 *         &lt;element name="Vypis_RZP" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.5}vypis_RZP" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class OdpovedRZP3 {
    ...
    protected List<VypisRZP3> vypisRZP;
     ...
     * 
     */
    public List<VypisRZP3> getVypisRZP() {
        if (vypisRZP == null) {
            vypisRZP = new ArrayList<VypisRZP3>();
        }
