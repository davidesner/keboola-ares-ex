 ...
 *         &lt;element name="Vypis_RES" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.5}vypis_RES" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class OdpovedRES3 {
    ...
    protected List<VypisRES3> vypisRES;
     ...
     * 
     */
    public List<VypisRES3> getVypisRES() {
        if (vypisRES == null) {
            vypisRES = new ArrayList<VypisRES3>();
        }
