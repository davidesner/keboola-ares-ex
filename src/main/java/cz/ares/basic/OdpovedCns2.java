...
@XmlType(name = "odpoved_cns", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3", propOrder = {
    "pid",
    "e",
    "vh",
    "pza",
...
public class OdpovedCns2 {
    ...
    protected List<VypisCNS2> vypisCNS;
     ...
     * 
     */
    public List<VypisCNS2> getVypisCNS() {
        if (vypisCNS == null) {
            vypisCNS = new ArrayList<VypisCNS2>();
        }
