...
@XmlType(name = "kontrolni_komise", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3", propOrder = {
    "clenKontrolniKomise",
    "t"
})
public class KontrolniKomise2 {

    @XmlElement(name = "Clen_kontrolni_komise")
    protected List<Clen2> clenKontrolniKomise;
    @XmlElement(name = "T")
     ...
     * 
     */
    public List<Clen2> getClenKontrolniKomise() {
        if (clenKontrolniKomise == null) {
            clenKontrolniKomise = new ArrayList<Clen2>();
        }
