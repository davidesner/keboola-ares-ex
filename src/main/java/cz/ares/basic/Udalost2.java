...
@XmlType(name = "udalost", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3", propOrder = {
    "pod",
    "tda",
    "tzm",
    "us",
...
public class Udalost2 {
     ...
     *     
     */
    public void setTZM(TypZmeny2 value) {
        this.tzm = value;
    }
