...
@XmlType(name = "zakladatele_SP", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3", propOrder = {
    "zsp",
    "t"
})
public class ZakladateleSP2 {
     ...
     * 
     */
    public List<Angazma2> getZSP() {
        if (zsp == null) {
            zsp = new ArrayList<Angazma2>();
        }
        return this.zsp;
    }
