 ...
 *       &lt;sequence>
 *         &lt;element name="Reditel_ops" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.5}angazma" maxOccurs="unbounded" minOccurs="0"/>
...
public class RediteleOps3 {

    @XmlElement(name = "Reditel_ops")
    protected List<Angazma3> reditelOps;
    @XmlElement(name = "T")
     ...
     * 
     */
    public List<Angazma3> getReditelOps() {
        if (reditelOps == null) {
            reditelOps = new ArrayList<Angazma3>();
        }
