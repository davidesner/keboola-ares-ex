 ...
 *       &lt;sequence>
 *         &lt;element name="LIR" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.5}angazma" maxOccurs="unbounded" minOccurs="0"/>
...
public class Likvidace3 {

    @XmlElement(name = "LIR")
    protected List<Angazma3> lir;
    @XmlElement(name = "T")
     ...
     * 
     */
    public List<Angazma3> getLIR() {
        if (lir == null) {
            lir = new ArrayList<Angazma3>();
        }
        return this.lir;
    }
