 ...
 *       &lt;sequence>
 *         &lt;element name="OON" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.5}angazma" maxOccurs="unbounded" minOccurs="0"/>
...
public class Nadace3 {

    @XmlElement(name = "OON")
    protected List<Angazma3> oon;
    @XmlElement(name = "T")
     ...
     * 
     */
    public List<Angazma3> getOON() {
        if (oon == null) {
            oon = new ArrayList<Angazma3>();
        }
        return this.oon;
    }
