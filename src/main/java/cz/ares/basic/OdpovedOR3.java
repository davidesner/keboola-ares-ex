 ...
 *         &lt;element name="Vypis_OR" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.5}vypis_OR" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class OdpovedOR3 {
    ...
    protected List<VypisOR3> vypisOR;
     ...
     * 
     */
    public List<VypisOR3> getVypisOR() {
        if (vypisOR == null) {
            vypisOR = new ArrayList<VypisOR3>();
        }
        return this.vypisOR;
    }
