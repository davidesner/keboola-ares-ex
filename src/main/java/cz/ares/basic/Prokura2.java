...
@XmlType(name = "prokura", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3", propOrder = {
    "pra",
    "t"
})
public class Prokura2 {
     ...
     * 
     */
    public List<Angazma2> getPRA() {
        if (pra == null) {
            pra = new ArrayList<Angazma2>();
        }
        return this.pra;
    }
