...
@XmlType(name = "sok", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3", propOrder = {
    "csk",
    "t"
})
public class Sok2 {
     ...
     * 
     */
    public List<Clen2> getCSK() {
        if (csk == null) {
            csk = new ArrayList<Clen2>();
        }
        return this.csk;
    }
