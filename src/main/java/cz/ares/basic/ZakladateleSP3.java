 ...
 *       &lt;sequence>
 *         &lt;element name="ZSP" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.5}angazma" maxOccurs="unbounded" minOccurs="0"/>
...
public class ZakladateleSP3 {

    @XmlElement(name = "ZSP")
    protected List<Angazma3> zsp;
    @XmlElement(name = "T")
     ...
     * 
     */
    public List<Angazma3> getZSP() {
        if (zsp == null) {
            zsp = new ArrayList<Angazma3>();
        }
        return this.zsp;
    }
