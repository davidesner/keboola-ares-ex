 ...
 *       &lt;sequence>
 *         &lt;element name="AKR" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.5}angazma" maxOccurs="unbounded" minOccurs="0"/>
...
public class Akcionari3 {

    @XmlElement(name = "AKR")
    protected List<Angazma3> akr;
    @XmlElement(name = "T")
     ...
     * 
     */
    public List<Angazma3> getAKR() {
        if (akr == null) {
            akr = new ArrayList<Angazma3>();
        }
        return this.akr;
    }
