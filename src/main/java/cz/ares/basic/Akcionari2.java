...
@XmlType(name = "akcionari", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3", propOrder = {
    "akr",
    "t"
})
public class Akcionari2 {

    @XmlElement(name = "AKR")
    protected List<Angazma2> akr;
    @XmlElement(name = "T")
     ...
     * 
     */
    public List<Angazma2> getAKR() {
        if (akr == null) {
            akr = new ArrayList<Angazma2>();
        }
        return this.akr;
    }
