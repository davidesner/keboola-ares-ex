...
@XmlType(name = "spolecnici_s_vkladem", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3", propOrder = {
    "ss",
    "t"
})
public class SpolecniciSVkladem2 {
     ...
     * 
     */
    public List<Angazma2> getSS() {
        if (ss == null) {
            ss = new ArrayList<Angazma2>();
        }
        return this.ss;
    }
