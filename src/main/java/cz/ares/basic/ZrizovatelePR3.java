 ...
 *       &lt;sequence>
 *         &lt;element name="ZPR" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.5}angazma" maxOccurs="unbounded"/>
...
public class ZrizovatelePR3 {

    @XmlElement(name = "ZPR", required = true)
    protected List<Angazma3> zpr;
    @XmlElement(name = "T")
     ...
     * 
     */
    public List<Angazma3> getZPR() {
        if (zpr == null) {
            zpr = new ArrayList<Angazma3>();
        }
        return this.zpr;
    }
