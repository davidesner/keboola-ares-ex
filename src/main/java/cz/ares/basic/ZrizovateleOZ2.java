...
@XmlType(name = "zrizovatele_OZ", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3", propOrder = {
    "zoz",
    "t"
})
public class ZrizovateleOZ2 {
     ...
     * 
     */
    public List<Angazma2> getZOZ() {
        if (zoz == null) {
            zoz = new ArrayList<Angazma2>();
        }
        return this.zoz;
    }
