...
@XmlType(name = "organ", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3", propOrder = {
    "ico",
    "of",
    "fu",
    "dic",
...
public class Organ2 {
    ...
    protected List<OrganFO2> organFO;
    @XmlAttribute
     ...
     * 
     */
    public List<OrganFO2> getOrganFO() {
        if (organFO == null) {
            organFO = new ArrayList<OrganFO2>();
        }
        return this.organFO;
    }
