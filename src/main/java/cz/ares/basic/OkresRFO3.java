 ...
 *         &lt;element name="Obec" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.5}obec_RFO" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class OkresRFO3 {
     ...
     * 
     */
    public List<ObecRFO3> getObec() {
        if (obec == null) {
            obec = new ArrayList<ObecRFO3>();
        }
        return this.obec;
    }
