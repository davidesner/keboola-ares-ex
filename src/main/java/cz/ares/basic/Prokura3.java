 ...
 *       &lt;sequence>
 *         &lt;element name="PRA" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.5}angazma" maxOccurs="unbounded" minOccurs="0"/>
...
public class Prokura3 {

    @XmlElement(name = "PRA")
    protected List<Angazma3> pra;
    @XmlElement(name = "T")
     ...
     * 
     */
    public List<Angazma3> getPRA() {
        if (pra == null) {
            pra = new ArrayList<Angazma3>();
        }
        return this.pra;
    }
