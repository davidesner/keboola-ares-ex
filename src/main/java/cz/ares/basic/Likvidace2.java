...
@XmlType(name = "likvidace", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3", propOrder = {
    "lir",
    "t"
})
public class Likvidace2 {
     ...
     * 
     */
    public List<Angazma2> getLIR() {
        if (lir == null) {
            lir = new ArrayList<Angazma2>();
        }
        return this.lir;
    }
