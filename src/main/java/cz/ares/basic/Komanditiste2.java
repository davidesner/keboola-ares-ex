...
@XmlType(name = "komanditiste", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3", propOrder = {
    "kma",
    "t"
})
public class Komanditiste2 {

    @XmlElement(name = "KMA")
    protected List<Angazma2> kma;
    @XmlElement(name = "T")
     ...
     * 
     */
    public List<Angazma2> getKMA() {
        if (kma == null) {
            kma = new ArrayList<Angazma2>();
        }
        return this.kma;
    }
