 ...
 *       &lt;sequence>
 *         &lt;element name="Organ" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.5}organ" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Organy3 {

    @XmlElement(name = "Organ")
    protected List<Organ3> organ;
     ...
     * 
     */
    public List<Organ3> getOrgan() {
        if (organ == null) {
            organ = new ArrayList<Organ3>();
        }
        return this.organ;
    }
