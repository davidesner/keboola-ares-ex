...
@XmlType(name = "odpoved_rcns", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3", propOrder = {
    "pid",
    "e",
    "vh",
    "pza",
...
public class OdpovedRcns2 {
    ...
    protected List<VypisRcns2> vypisRcns;
     ...
     * 
     */
    public List<VypisRcns2> getVypisRcns() {
        if (vypisRcns == null) {
            vypisRcns = new ArrayList<VypisRcns2>();
        }
