 ...
 *       &lt;sequence>
 *         &lt;element name="NACE" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.5}kod_nace" maxOccurs="unbounded"/>
 *         &lt;element name="Nazev_NACE" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.5}nazev_nace" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Nace3 {
     ...
     * 
     */
    public List<KodNace3> getNACE() {
        if (nace == null) {
            nace = new ArrayList<KodNace3>();
        }
        return this.nace;
    }
