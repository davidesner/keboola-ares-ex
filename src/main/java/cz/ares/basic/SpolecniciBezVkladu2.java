...
@XmlType(name = "spolecnici_bez_vkladu", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3", propOrder = {
    "sb",
    "t"
})
public class SpolecniciBezVkladu2 {
     ...
     * 
     */
    public List<Angazma2> getSB() {
        if (sb == null) {
            sb = new ArrayList<Angazma2>();
        }
        return this.sb;
    }
