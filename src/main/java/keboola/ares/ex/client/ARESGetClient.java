...
public class ARESGetClient {
    ...
    private static final String STANDARD_REQUEST_URL = "https://wwwinfo.mfcr.cz/cgi-bin/ares/darv_std.cgi";
    private static final String BASIC_REQUEST_URL = "https://wwwinfo.mfcr.cz/cgi-bin/ares/darv_bas.cgi";
